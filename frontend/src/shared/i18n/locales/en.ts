...
const en = {
  common: {
    ...
    // Shared by every admin list so the three pages describe filtering the
    // same way. Page-specific wording (what a search actually covers) stays
    // with the page.
    search: {
      clear: "Clear search",
      results: "{count} of {total} shown",
    },
  ...
  services: {
    ...
    translationHint: "Shown to patients reading the site in Arabic.",
    statusActive: "Active",
    ...
    filterAll: "All",
    filterEmpty: "No services match these filters.",
  ...
  slots: {
    ...
    allServicesCover: "Cover across all services",
    everyDay: "Every day",
    createNeedsService: "Choose a single service to add a slot to it.",
  ...
  bookings: {
    ...
    filterAll: "All",
    filterEmpty: "No bookings match these filters.",
    unnamedService: "Service #{id}",

    searchLabel: "Search bookings",
    searchPlaceholder: "Patient, email, phone, or service",
